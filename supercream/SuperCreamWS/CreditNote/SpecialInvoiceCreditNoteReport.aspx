<%@ Page Title="" Language="C#" MasterPageFile="~/SingleColumnMasterPage.master"
    AutoEventWireup="true" StylesheetTheme="SuperCreamReports" CodeFile="SpecialInvoiceCreditNoteReport.aspx.cs"
    Inherits="CreditNote_SpecialInvoiceCreditNoteReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainPlaceholder" runat="Server">
    ...
    <rsweb:ReportViewer ID="CreditNoteReportViewer" Style="width: 100%;" runat="server"
        ...
        <LocalReport ReportPath="SpecialInvoiceCreditNotePrint.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>
