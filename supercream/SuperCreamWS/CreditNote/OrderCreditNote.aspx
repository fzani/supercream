<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" StylesheetTheme="SuperCream" CodeFile="OrderCreditNote.aspx.cs" Inherits="CreditNote_OrderCreditNote" %>

<%@ Register Src="~/Controls/ErrorView.ascx" TagName="ErrorView" TagPrefix="Alterax" %>
<%@ Register Src="../Controls/NewOrderCreditNote.ascx" TagName="NewCreditNote" TagPrefix="uc1" %>
<%@ Register Src="../Controls/MaintainOrderCreditNote.ascx" TagName="MaintainCreditNote"
    TagPrefix="uc2" %>
